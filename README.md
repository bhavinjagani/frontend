...
You will submit a github link with your response.
...
_You can also work locally first, and upload at the end._
...
If you work locally to solve the challenge, make sure you upload to github and provide submission link at the end.
...
- Plagiarism is a serious offense and will result in disqualification from further consideration - use of AI tools(CoPilot, etc) to solve this without comments noting which specific sections of code were supplied by automated tools counts as plagiarism.
